...
with Diagram("", filename="main", show=False, direction="TB", graph_attr=graph_attr, node_attr=node_attr):
  ...
  with Cluster("Aurora Cluster", direction="TB"):
            Rdscluster = Aurora("Aurora RDS")
            with Cluster ("Cluster Instances"):
              Primary = AuroraInstance("Writer Instance")
              Secondary = AuroraInstance("Read-Only \n Instance")
